...
const RelatedGrid = ({ids}: {ids : Array<number>}) => {
  ...
  <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 lg:gap-5 text-black dark:text-white justify-stretch">
